...
setwd("~/Applications Note for zalpha package/Simulations/Results")
...
setwd("~/Applications Note for zalpha package/Simulations/Results/wide")
...
setwd("~/Applications Note for zalpha package/Simulations/Results/wide/rocNeutralSelected")
for (i in 1:35){
...
setwd("~/Applications Note for zalpha package/Simulations/Results/wide/rocNeutralMidSelected")
for (i in 1:35){
  png(paste0(colnames(neutralResults)[i+1],".png"),res=300,width=14,height=14,units="cm")
...
setwd("~/Applications Note for zalpha package/Simulations/Results/wide/rocMidSelectedEndSelected")
for (i in 1:35){
