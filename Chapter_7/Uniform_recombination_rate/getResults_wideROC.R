...
write.csv(selectedResults,"/home/ch19g17/Sim_for_zalpha_paper/selectedResults_wide.csv",row.names=FALSE)
write.csv(selectedMidResults,"/home/ch19g17/Sim_for_zalpha_paper/selectedMidResults_wide.csv",row.names=FALSE)
write.csv(neutralResults,"/home/ch19g17/Sim_for_zalpha_paper/neutralResults_wide.csv",row.names=FALSE)
