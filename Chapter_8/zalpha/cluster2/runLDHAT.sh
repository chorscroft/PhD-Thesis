...
chromDir=/temp/hgig/EXOME_DATA/Clare/Dogs/cluster2/LDprofile/chr$chrom

## Converts the clipped, clean dog data into VCF
module load plink/1.90beta
plink --dog --tfile /temp/hgig/EXOME_DATA/Clare/Dogs/cluster2/LDprofile/chr$chrom --chr $chrom --recode vcf --out $chromDir/cleanVCF
