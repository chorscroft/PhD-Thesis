...
SNPs<-read_excel("H:/Dogs/cluster2/Candidate Regions/Candidate Regions C2.xlsx","Overlap",col_types = c("numeric","numeric","numeric"))
PrevPub<-read_excel("H:/Dogs/cluster2/Candidate Regions/Candidate Regions C2.xlsx","PrevPublished","A1:E535",col_types = c("numeric","numeric","numeric","text","text"))
...
write.table(overlap,"H:/Dogs/cluster2/Candidate Regions/overlap.txt",col.names = FALSE,quote=FALSE,sep = "\t")
