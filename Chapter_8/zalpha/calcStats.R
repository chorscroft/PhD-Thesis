...
for (chr in 1:38){
  ...
  Zalpha_all<-read.table(paste0("/temp/hgig/EXOME_DATA/Clare/Dogs/zalpha/zalpha_all/chr",chr,"/zalpha_chr_",chr,".txt"),header=TRUE, stringsAsFactors=FALSE)
  dfResults<-calculateResults(Zalpha_all)
  write.table(dfResults,paste0("/temp/hgig/EXOME_DATA/Clare/Dogs/zalpha/zalpha_all/chr",chr,"/all_stats_chr_",chr,".txt"),row.names=FALSE,quote=FALSE)  
