...
for (i in 1:38){
  ## read in current map
  ldhatMap<-read.table(paste0("/temp/hgig/EXOME_DATA/Clare/Dogs/LDprofile/LDHAT/chr",i,"/res.txt"),header=TRUE)
  ...
  # write map to file
  write.table(newMap,paste0("/temp/hgig/EXOME_DATA/Clare/Dogs/LDprofile/LDHAT/chr",i,"/cM_map_chr",i,".txt"),quote=FALSE,row.names=FALSE)
